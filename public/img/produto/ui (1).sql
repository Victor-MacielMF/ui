...
--
-- Host: mysql
-- Tempo de geração: 27-Out-2021 às 06:44
...
INSERT INTO `comentarios` (`id`, `produto_id`, `user_id`, `comentario`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'awdadawdaw', '2021-10-27 06:42:37', '2021-10-27 06:42:37');

-- --------------------------------------------------------

--
-- Estrutura da tabela `comentario_respostas`
--
...
--
-- Extraindo dados da tabela `comentario_respostas`
--

INSERT INTO `comentario_respostas` (`id`, `comentario_id`, `user_id`, `comentario`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '156156615', '2021-10-27 06:42:53', '2021-10-27 06:42:53');
...
(1, 1, '77.600-000', 'Paraíso do Tocantins', 'TO', 'Rua Azulao', '796', NULL, 'Jardim Paulista', NULL, '2021-10-27 06:39:21', '2021-10-27 06:39:21');
...
(15, '2021_10_27_042354_create_comentario_respostas_table', 1);
...
(1, 1, 'Robô Otto', 'awddwdaw', 'Robô perfeito para montar com seu filho', 100.00, 5, NULL, NULL);
...
(1, 'João Victor Maciel de Freitas', 'joaovictormacieldefreitas2345@gmail.com', NULL, '$2y$10$5.uzd0wJIsQxCxpo.ZG1n.t2o87EMtl5RyR7HraU33/eU0jXVaQR6', '950.207', '040.081.351-38', '1999-09-02 00:00:00', 'M', '(63) 98447-2602', NULL, NULL, '2021-10-27 06:39:21', '2021-10-27 06:39:21');
...
--
-- Índices para tabela `comentario_respostas`
--
ALTER TABLE `comentario_respostas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comentario_respostas_comentario_id_foreign` (`comentario_id`),
  ADD KEY `comentario_respostas_user_id_foreign` (`user_id`);
...
ALTER TABLE `compatibilidades`
  ...
  ADD KEY `compatibilidades_produto_id_foreign` (`produto_id`);
...
--
-- AUTO_INCREMENT de tabela `comentario_respostas`
--
ALTER TABLE `comentario_respostas`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Limitadores para a tabela `comentario_respostas`
--
ALTER TABLE `comentario_respostas`
  ADD CONSTRAINT `comentario_respostas_comentario_id_foreign` FOREIGN KEY (`comentario_id`) REFERENCES `comentarios` (`id`),
  ADD CONSTRAINT `comentario_respostas_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
ALTER TABLE `compatibilidades`
  ...
  ADD CONSTRAINT `compatibilidades_produto_id_foreign` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`);
